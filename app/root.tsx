...
export function ErrorBoundary({ error }: Route.ErrorBoundaryProps) {
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-16 text-zinc-100">
      ...
      <p className="mt-3 text-sm text-zinc-400">{details}</p>
      {stack && (
        <pre className="mt-6 w-full overflow-x-auto rounded-xl border border-white/10 bg-zinc-950 p-4 text-xs text-zinc-300">
          <code>{stack}</code>
        </pre>
      )}
    </main>
